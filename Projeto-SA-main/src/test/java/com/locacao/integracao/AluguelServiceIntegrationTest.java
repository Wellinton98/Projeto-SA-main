...
public class AluguelServiceIntegrationTest {
    ...
    public void deveSalvarEBuscarImovel() {
        // Onde ele tem que buscar por id e retonar com sucesso, comm um id ja cadastrado.
        ...
        // Verificação de id com sucessso. 
    ...
    public void deveLancarExcecaoAoBuscarIdInexistente() {
        // aqui ele deve lançar erro com id ja existente, ao tentar ser salvo com o id existente.
        Integer idInexistente = 9999;

        // Verifica se o service lança RuntimeException 
    ...
    public void deveDeletarImovel() {
        ...
        // Verifica se o ID sumiu, e deve da erro ao tentar buscar novamente
        assertThrows(RuntimeException.class, () -> {
